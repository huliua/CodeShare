...
<template>
    <el-row class="main-content">
        <!-- 右键菜单 -->
        <ul ref="target" v-show="showContextMenu" v-click-outside="clickOutSide" :style="{ left: left + 'px', top: top + 'px' }" class="contextMenu">
            <li @click="renameNode">
        ...
        <el-col :span="fileTree.length > 0 ? 10 : 24" class="file-tree">
            <el-row>
                <el-col :span="24">
                    <el-button v-if="!readOnly" :icon="CirclePlus" @click="append(null)" style="margin: 8px 4px">新增文件</el-button>
                    <el-tree
                    ...
                    >
                        <template #default="{ node, data }">
                            <span class="custom-tree-node" ref="treeNodeRef">
                                ...
                                <span v-if="!readOnly" style="display: flex">
    ...
    <el-collapse :model-value="['baseInfo']">
        <el-collapse-item title="基本信息" name="baseInfo">
            <el-form :model="moreSettingForm" ref="moreSettingFormRef" :rules="moreSettingFormRules" label-width="100px" :inline="false" :size="'default'" :disabled="readOnly">
