        ...
        <el-col :span="fileTree.length > 0 ? 10 : 24" class="file-tree">
            <el-row>
                <el-col :span="24">
                    ...
                    <el-tree :highlight-current="true" ref="treeRef" style="max-width: 98%" :data="fileTree" :node-key="'id'" default-expand-all :expand-on-click-node="false" @node-click="doSelect" :props="{ label: 'name', children: 'children', class: 'file-tree-node' }" @node-contextmenu="treeNodeRightClick">
