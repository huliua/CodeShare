        ...
        <el-col :span="fileTree.length > 0 ? 10 : 24" class="file-tree">
            <el-row>
                <el-col :span="24">
                    ...
                    <el-tree ref="treeRef" :highlight-current="true" style="max-width: 98%" :data="fileTree" :node-key="'id'" default-expand-all :expand-on-click-node="false" :props="{ label: 'name', children: 'children', class: 'file-tree-node' }" @node-click="doSelect">
                        <template #default="{ node, data }">
                            <span class="custom-tree-node">
                                ...
                                <span style="display: flex">
                                    <el-icon v-if="data.type === 'folder'" @click="append(node)">
                                        <CirclePlus />
                                    </el-icon>
